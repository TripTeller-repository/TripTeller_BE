...
//   // 모든 공개 게시물 조회 (페이지네이션)
//   async fetchPublicFeedsPaginated(pageNumber: number = 1, pageSize: number = 9) {
//     const criteria = {
//       isPublic: true,
//       $or: [{ deletedAt: null }, { deletedAt: { $exists: false } }],
//     };
...
//   async fetchOnePublicFeed(feedId: string) {
//     const criteria = {
//       isPublic: true,
//       _id: feedId,
//       $or: [{ deletedAt: null }, { deletedAt: { $exists: false } }],
...
//   async sortPublicByRecent(pageNumber: number = 1, pageSize: number = 9) {
//     const criteria = {
//       isPublic: true,
//       $or: [{ deletedAt: null }, { deletedAt: { $exists: false } }],
//     };
...
//   async sortPublicByLikeCount(pageNumber: number = 1, pageSize: number = 9) {
//     const criteria = {
//       isPublic: true,
//       $or: [{ deletedAt: null }, { deletedAt: { $exists: false } }],
//     };
